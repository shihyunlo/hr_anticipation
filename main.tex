...
We intend to collect more data to allow robust prediction on human path 
crossing decision before and after the robot indicates intention (shown in Eq.~\ref{eq:logi}~\ref{eq:transition}).
