...
$Beta(\alpha+1, \beta+1)$.\commentp{it's awkward to use Beta as the function and the variable...} However, diagnosis of past interactions is
...
Our subject, human crossing behavior in crowds, is considered as potential 
...
Based on the observed frequency of intention communication\commentp{How is the frequency of intention communication measured?} and the safety margins 
kept from the robot, we informally categorize people into four groups, 
